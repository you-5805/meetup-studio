  ...
  return (
    <DefaultSeo
      {...{
        ...
        description:
          'オフラインのミートアップをよりインタラクティブにするアプリケーションです。登壇者の発表に対して参加者からのチャットやリアクション、投票の結果をリアルタイムで表示することで、オフラインイベントの交流の難しさを解消します。Meetup Studioを使えば、あなたのイベントはより多くの人々の興味を引くことができます。',
        openGraph: {
          type: 'website',
